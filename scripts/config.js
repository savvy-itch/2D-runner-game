...
export const initialForegroundVel = window.innerWidth > 1024 ? 6 : 3;
...
export const offsetPerFrame = window.innerWidth > 1024 ? 55 : 40;
export const runSprites = 7;
export const spriteX = 128;
export const spriteY = 128;
export const spriteXNoPadding = 46;
export const spriteYNoPadding = 75;
export const spriteXScaled = Math.round(spriteXNoPadding * smallScreenCoefficient);
export const spriteYScaled = Math.round(spriteYNoPadding * smallScreenCoefficient);
export const idleSpriteXNoPadding = 51;
export const idleXScaled = Math.round(idleSpriteXNoPadding * smallScreenCoefficient);
export const jumpSpriteXNoPadding = 59;
...
export const idleXPadding = (spriteX - idleSpriteXNoPadding) / 2;
export const jumpXPadding = (spriteX - jumpSpriteXNoPadding) / 2;
